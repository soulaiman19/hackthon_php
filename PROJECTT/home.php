...
<div class="container">
  ...
  <div class="main-content">
    ...
    <div class="story-gallery">
      <div class="story story1"><img src="images/upload.png"><p>POST STORY</p></div>
      <div class="story story2"><img src="images/member-1.png"><p>ALISON</p></div>
      <div class="story story3"><img src="images/member-2.png"><p>JACKSON</p></div>
      <div class="story story4"><img src="images/member-3.png"><p>MONI</p></div>
      <div class="story story5"><img src="images/member-4.png"><p>NOMO</p></div>
    </div>
    ...
    <div class="write-post-container">
      ...
      <textarea rows="3" placeholder="What's on your mind, <?php echo $_SESSION['username']; ?>?"></textarea>
    ...
    <div class="post-container">
      <div class="post-row">
        <div class="user-profile">
          ...
          <div>
            <p>Samona Rose</p>
            <span>April 04 at 11:48 AM  <i class="fa-solid fa-globe"></i></span>
          </div>
        </div>
        <a href="#"><i class="fas fa-ellipsis-v"></i></a>
      </div>
      ...
      <p class="post-text">
        liysi  <span>@ETUTORIALS</span> YouTube Channel for more updates
        <a href="#">YouTubeChannel</a>
      </p>
    ...
    <div class="post-container">
      <div class="post-row">
        <div class="user-profile">
          ...
          <div>
            <p>LIZI NILB</p>
            <span>Novenbre 15 at 13:30 PM  <i class="fa-solid fa-globe"></i></span>
          </div>
        </div>
        <a href="#"><i class="fas fa-ellipsis-v"></i></a>
      </div>
      ...
      <p class="post-text">
        SUBSCRIBE <span>@EASY </span> YouTube Channel for more updates
        <a href="#">YouTubeChannel</a>
      </p>
    ...
    <div class="post-container">
      <div class="post-row">
        <div class="user-profile">
          ...
          <div>
            <p>MARYAM</p>
            <span>April 29at 12:09 AM  <i class="fa-solid fa-globe"></i></span>
          </div>
        </div>
        <a href="#"><i class="fas fa-ellipsis-v"></i></a>
      </div>
  ...
  <div class="right-sidebar">
    ...
    <div class="event">
      ...
      <div class="event-right">
        ...
        <a href="#" class="event-btn">More Info</a>
      </div>
    </div>
